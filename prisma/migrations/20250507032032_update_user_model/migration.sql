/*
  ...
  - You are about to drop the column `licenseDate` on the `user` table. All the data in the column will be lost.
  - You are about to drop the column `phone` on the `user` table. All the data in the column will be lost.

*/
-- DropIndex
DROP INDEX "Entreprise_siren_key";

-- DropIndex
DROP INDEX "Entreprise_tahiti_number_key";
